...
str_const2:
	...
	.word	String_dispTab
	.word	int_const14
	.ascii	"TP 1 Compiladores 2016/2 - Tadeu Rahian\n"
	.byte	0	
	.align	2
	.word	-1
str_const1:
...
class_objTab:
	...
	.word	String_protObj
	.word	String_init
	.word	StackElement_protObj
	.word	StackElement_init
	.word	A2I_protObj
	.word	A2I_init
Object_dispTab:
	.word	Object.abort
...
A2I_dispTab:
	...
	.word	A2I.i2a
	.word	A2I.i2a_aux
StackElement_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	StackElement.init
	.word	StackElement.getValue
	.word	StackElement.setElementBelow
	.word	StackElement.getElementBelow
String_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
...
Stack_dispTab:
	...
	.word	Stack.init
	.word	Stack.push
	.word	Stack.pushValue
	.word	Stack.pop
	.word	Stack.getSize
	.word	Stack.printStack
	.word	-1
Object_protObj:
	.word	0
	.word	3
...
A2I_protObj:
	...
	.word	A2I_dispTab
	.word	-1
StackElement_protObj:
	.word	7
	.word	5
	.word	StackElement_dispTab
	.word	0
	.word	str_const4
	.word	-1
String_protObj:
...
Stack.pushValue:
	...
	addiu	$fp $sp 4
	move	$s0 $a0
	la	$a0 StackElement_protObj
	jal	Object.copy
	jal	StackElement_init
	sw	$a0 16($s0)
	lw	$a0 12($fp)
	sw	$a0 0($sp)
	addiu	$sp $sp -4
